...
test('content: digYield trebuie sa acopere TOATE materialele solide, si nu accepta unul nesolid sau un fel necunoscut', async () => {
  ...
  const baza = { ...R, digYield: { ROCA: { fel: 'PIATRA', cantitate: 20 }, PAMANT: { fel: 'PAMANT', cantitate: 10 }, IARBA: { fel: 'PAMANT', cantitate: 10 }, LEMN_CONSTRUIT: { fel: 'LEMN', cantitate: 5 }, PIATRA_CONSTRUITA: { fel: 'PIATRA', cantitate: 20 } } }
...
test('pictarea intinde acoperirea de regiuni: fiecare celula de zona e intr-o regiune calculata imediat dupa comanda', () => {
  ...
  // Departe de pion, in directia opusa oricarei desemnari: nimeni n-a umblat acolo.
