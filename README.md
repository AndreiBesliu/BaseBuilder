...
**Stare: preproducție.** Nucleul de simulare există; jocul nu. Ce se simulează acum e un substitut
deliberat — agenți care fac o plimbare aleatoare mărginită — al cărui rol e să exercite mecanismele
care nu se pot retrofita (fluxuri de RNG, ordine fixă de iterare, aritmetică întreagă, hash de
stare), ca dovada de determinism să existe **înainte** să existe teren, agenți adevărați sau joburi.
...
npm run check        # disciplina + typecheck + 48 de teste
...
tests/          48 de teste, inclusiv probe negative pentru instrumente
```
