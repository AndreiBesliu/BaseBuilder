...
| **S6-8** | **Coloana vertebrală de randare.** Mesher binary greedy pe măști `Uint32` per coloană ✅; viewer three.js cu slice view și picking ✅; **streaming de chunkuri cu buget pe cadru + traversare pe șine** ✅ (fără el, S-TRAVERSE — scenariul de gate — nu se putea rula); netezirea suprafeței *(panou de proiectare în curs)*; mesher în worker. | 0 |
