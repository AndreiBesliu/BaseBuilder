...
| **S9-11** | **Regiuni + reachability.** Partiție 16×16 per z-slice ✅, graf de regiuni ✅, reachability prin union-find ✅, fuzz de 10.000 de edituri ✅. **Măsurat:** o reconstrucție costă ~30 ms la ~100 de blocuri rezidente, adică peste 30× bugetul unei săpături — reconstrucția incrementală devine obligatorie la primul agent care cere un drum (S12-15). Rămâne overlay-ul de debug. | 1 |
